              ...
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <div class="card-body">
                      <b><a class="btn btn-primary mr-1" href='affichage_liste_etudiant_dg.php'>Consulter</a></b>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <div class="card-body">
                      <b><a class="btn btn-primary mr-1" href='affichage_liste_classe_dg.php'>Consulter</a></b>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <div class="card-body">
                      <b><a class="btn btn-primary mr-1" href='liste_AttestationInscription_dg.php'>Consulter</a></b>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <div class="card-body">
                      <b><a class="btn btn-primary mr-1" href='affichage_liste_module_dg.php'>Consulter</a></b>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <div class="card-body">
                      <b><a class="btn btn-primary mr-1" href='liste_etudiant_classe_dg.php'>Consulter</a></b>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <div class="card-body">
                      <b><a class="btn btn-primary mr-1" href='affichage_liste_groupe_dg.php'>Consulter</a></b>
                    </div>
                  </div>
                </div>
              </div>
