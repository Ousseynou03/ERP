      ...
      <div class="main-sidebar sidebar-style-2">
        ...
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">Liste des étudiants de la classe S3</h2>
                ...
                <div class="card-header">
                  ...
                  <div class="card-body">
                    <table class="table table-striped">
                      ...
                      <tbody>
                      <?php  $getInfosOfThisEtudiantClasseReq = $bdd->query("SELECT * FROM etudiant WHERE Code_Classe='A0013' ORDER BY Nom,Prenom,DatedeNaissance ");
     ...
     <?php
                  ...
                  <div class="card-body">
                    <table class="table table-striped">
                      ...
                      <tbody>
                      <?php  $getInfosOfThisModuleClasseReq = $bdd->query("SELECT * FROM module WHERE Code_Classe='A0013' ORDER BY NomModule ");
