                ...
                <div class="card-header">
                  ...
                  <div class="card-body">
                    <table class="table table-striped">
                      ...
                      <tbody>
                      <?php  $getInfosOfThisEtudiantClasseReq = $bdd->query("SELECT * FROM etudiant WHERE Code_Classe='A0019' ORDER BY Nom,Prenom,DatedeNaissance ");
     ...
     <?php
                  ...
                  <div class="card-body">
                    <table class="table table-striped">
                      ...
                      <tbody>
                      <?php  $getInfosOfThisModuleClasseReq = $bdd->query("SELECT * FROM module WHERE Code_Classe='A0019' ORDER BY NomModule ");
