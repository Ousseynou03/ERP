<?php 
include'signup_AttestationInscription.php' ; 
?>
...
<form action="" method="POST">
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Delivrer une attestation d'inscription</h1>
          ...
          <div class="section-body">
            <h2 class="section-title">Ajouter les réferences</h2>
            ...
            <div class="card-body">
                    <div class="alert alert-info">
                      <b>
                      <a href='liste_AttestationInscription.php'>Consulter la liste des attestions délivrées</a>
                      </b>
        ...
        ?>
                    ...
                    <div class="form-group">
                      <label>Réference Reçu</label>
                      <input type="varchar" class="form-control" name="ReferenceRecu">
                    </div> 
                   
        
                    <div class="form-group">
                      <label>Date du reçu </label>
                      <input type="date" class="form-control" name="DateRecu">
                    </div>

                    <div class="form-group">
                      <label>Date de la remise du reçu </label>
                      <input type="date" class="form-control" name="DateremiseRecu">
                    </div>
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2022 <div class="bullet"></div>  By <a href="">Ousseynou Dione</a>
        </div>
