      ...
      <div class="main-sidebar sidebar-style-2">
        ...
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">Liste des classes de l'école</h2>
                ...
                <div class="card-header">
                  ...
                  <div class="card-body">
                    <table class="table table-striped">
                      ...
                      <tbody>
                      <?php   $getInfosOfThisClasseReq = $bdd->query('SELECT * FROM classe');
                               while($classesInfos = $getInfosOfThisClasseReq->fetch()) {    ?>
     <tr>
     <?php 
            echo "<td>".$classesInfos['Code_Classe']."</td>";
            echo "<td>".$classesInfos['Annee_Universitaire']."</td>";
            echo "<td>".$classesInfos['Semestre']."</td>";
            echo "<td>".$classesInfos['Niveau']."</td>"; 
            echo "<td><a href=\"modifier_Classe.php?Code_Classe=$classesInfos[Code_Classe]\">Modifier</a> | <a href=\"delete_Classe.php?Code_Classe=$classesInfos[Code_Classe]\" onClick=\"return sure()\">Spprimer</a></td>";        
                                  }?>
                                  <script>
                                function sure()
                                {
