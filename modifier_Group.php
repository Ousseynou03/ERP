...
<form action="" method="POST">
      ...
      <div class="main-content">
          ...
          <div class="section-body">
            ...
            <div class="card-body">
                    <div class="alert alert-info">
                      <b>
                      <a href='affichage_liste_etudiant.php'>Consulter la liste des groupes</a>
                      </b>
        ...
        ?>
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" name="annee_u" value="<?=$annee_u;?>">
                    </div>
                    <div class="form-group">
                      <label>NIVEAU</label>
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2022 <div class="bullet"></div> Design By Ousseynou Dione <a href=""></a>
        </div>
