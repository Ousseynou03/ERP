      ...
      <div class="main-sidebar sidebar-style-2">
        ...
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">Liste des modules de l'école</h2>
                ...
                <div class="card-header">
                  ...
                  <div class="card-body">
                    <table class="table table-striped">
                      <thead>
                        <tr> 
                        <th scope="col">Identifiant module</th>
                      ...
                      <tbody>
                      <?php  $getInfosOfThisModuleReq = $bdd->query('SELECT * FROM module');
        while($modulesInfos = $getInfosOfThisModuleReq->fetch()) {    ?>
     <tr>
     <?php 
            echo "<td>".$modulesInfos['id_module']."</td>";
            echo "<td>".$modulesInfos['NomModule']."</td>";
            echo "<td>".$modulesInfos['Type']."</td>";
            echo "<td>".$modulesInfos['Coefficient']."</td>"; 
            echo "<td>".$modulesInfos['Code_Classe']."</td>";
            echo "<td><a href=\"modifier_Module.php?id_module=$modulesInfos[id_module]\">Modifier</a> | <a href=\"delete_Module.php?id_module=$modulesInfos[id_module]\" onClick=\"return sure()\">Spprimer</a></td>";                   
                                  }?>
                                     <script>
                                function sure()
                                {
