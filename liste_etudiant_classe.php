        ...
        <section class="section">
          ...
          <div class="section-body">
            ...
            <p class="section-lead">
             C'est par ici si une classe n'a pas été ajouté <a href="ajout_Classe.php">here</a>.
            </p>
            <div class="row">
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    <div class="mb-2">Classe S1</div>
                    <div class="card-body">
                      <b><a class="btn btn-primary mr-1" href='classe_S1.php'>Consulter</a></b>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    <div class="mb-2">Classe S2</div>
                    <div class="card-body">
                      <b><a class="btn btn-primary mr-1" href='classe_S2.php'>Consulter</a></b>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    <div class="mb-2">Classe S3</div>
                    <div class="card-body">
                      <b><a class="btn btn-primary mr-1" href='classe_S3.php'>Consulter</a></b>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    <div class="mb-2">Classe S4</div>
                    <div class="card-body">
                      <b><a class="btn btn-primary mr-1" href='classe_S4.php'>Consulter</a></b>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    <div class="mb-2">Classe S5</div>
                    <div class="card-body">
                      <b><a class="btn btn-primary mr-1" href='classe_S5.php'>Consulter</a></b>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    <div class="mb-2">Classe S6</div>
                    <div class="card-body">
                      <b><a class="btn btn-primary mr-1" href='classe_S6.php'>Consulter</a></b>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    <div class="mb-2">Classe S7</div>
                    <div class="card-body">
                      <b><a class="btn btn-primary mr-1" href='classe_S7.php'>Consulter</a></b>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    <div class="mb-2">Classe S8</div>
                    <div class="card-body">
                      <b><a class="btn btn-primary mr-1" href='classe_S8.php'>Consulter</a></b>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    <div class="mb-2">Classe S9</div>
                    <div class="card-body">
                      <b><a class="btn btn-primary mr-1" href='classe_S9.php'>Consulter</a></b>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    <div class="mb-2">Classe S10</div>
                    <div class="card-body">
                      <b><a class="btn btn-primary mr-1" href='classe_S10.php'>Consulter</a></b>
                    </div>
                  </div>
                </div>
              </div>
